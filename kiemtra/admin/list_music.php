<?php
    ...
    try{
        ...
        $n = ($page -1) * 10;
        $sql = "SELECT * FROM baihat ORDER BY id ASC LIMIT 10 OFFSET $n";
        $stmt = $conn->prepare($sql);
        $stmt->execute();
        $baihat = $stmt->fetchAll();
    ...
    <div class="row">
        ...
        <div class="col-md-9 main">
            ...
            <div class="main-content vh-100 p-3">
                <h3 class=" text-center text-uppercase">List Bài hát </h3>
                <a href="music_add.php" class="btn btn-success"><ion-icon name="add-circle-outline"></ion-icon></i>Thêm bài hát</a>
                <?php
